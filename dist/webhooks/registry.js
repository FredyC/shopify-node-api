...
var WebhooksRegistry = {
                ...
                switch (_c.label) {
                    case 0:
                        ...
                        address = deliveryMethod === types_1.DeliveryMethod.Http
                            ? "https://".concat(context_1.Context.HOST_NAME).concat(path)
                            : path;
    ...
    processRaw: function (reqBody, request, response) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        if (missingHeaders.length) {
                            ...
                            response.end();
                            throw new ShopifyErrors.InvalidWebhookError("Missing one or more of the required HTTP headers to process webhooks: [".concat(missingHeaders.join(', '), "]"));
                        }
                        headers = {};
